        ...
        <div className="quiz-stats">
          ...
          {quizStats.total === 0 && (
            <div className="quiz-stats__empty">
              <p>No quiz answers yet. Visit the <Link href="/">Home page</Link> to try the Question of the Day!</p>
            </div>
          )}
              ...
              <div key={id} className={`profile-course profile-course--${color} ${progress[id] ? 'profile-course--done' : ''}`}>
                ...
                <div className="profile-course__right">
                  {progress[id] ? (
                    ...
                    <Link href={path} className="profile-course__status profile-course__status--go">
