    ...
    <div className="home">
      ...
      <section className="hero">
        ...
        <div className="hero__content container">
          ...
          <div className="hero__actions">
            <Link href="/typescript" className="hero__btn hero__btn--primary">
              Start Learning <FiArrowRight />
            </Link>
            <Link href="/playwright" className="hero__btn hero__btn--secondary">
      ...
      <section className="paths section">
        <div className="container">
          ...
          <div className="paths__grid">
            <Link href="/typescript" className="path-card path-card--blue">
            ...
            <Link href="/playwright" className="path-card path-card--green">
            ...
            <Link href="/pom" className="path-card path-card--purple">
